...
dependencies {
    // Core Android - Compatible with compileSdk 34
    ...
    implementation("com.squareup.okhttp3:okhttp:4.12.0") // Hapus duplikasi

    // Coroutines
    implementation("org.jetbrains.kotlinx:kotlinx-coroutines-android:1.7.3") // Hapus duplikasi
